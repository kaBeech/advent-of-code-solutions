...
func GetFutureIntersectionsInTestArea(intersections []Intersection, testArea TestArea) []Intersection {
	...
	for _, intersection := range intersections {
		if checkIfIntersectionIsInTestArea(intersection, testArea) && checkIfIntersectionIsInBothHailstonesFuturePath(intersection) {
...
func checkIfIntersectionIsInBothHailstonesFuturePath(intersection Intersection) bool {
