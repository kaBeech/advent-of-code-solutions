...
def get_connection_by_component_ids(component1_id: str, component2_id: str, connections: list[Connection]) -> Connection | None:
    for connection in connections:
        if connection.component1.id == component1_id and connection.component2.id == component2_id:
            return connection
        if connection.component1.id == component2_id and connection.component2.id == component1_id:
            return connection
    return None
